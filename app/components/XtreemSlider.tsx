...
const SLIDES: Slide[] = [
  {
    ...
    body: "A bold 250ml can built for standout brand moments on every pitch.",
  ...
  },
  {
    ...
    body: "At 15,000 feet, Xtreem Pro brings bold branding and a distinctive caffeinated-drink identity.",
    badge: "250ml Caffeinated Drink",
  },
  {
    ...
    body: "Mountain trails, massive air and unmistakable Xtreem Pro presence in every frame.",
    badge: "Bold Caffeinated Drink",
  },
  {
    ...
    body: "Cities are arenas. Bring Xtreem Pro into every street scene with a bold urban look.",
    badge: "High Caffeine",
  },
  {
    ...
    body: "B-Vitamin Complex. Taurine. Natural caffeine. One can with a bold, ready-to-drink profile.",
  ...
  },
  {
    ...
    body: "On wet tarmac, milliseconds make legends. Xtreem Pro delivers a sharp, premium caffeinated-drink identity.",
