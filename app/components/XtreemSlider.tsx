...
const SLIDES: Slide[] = [
  {
    ...
    alt: "Xtreem Pro at a football stadium",
    eyebrow: "Global Icon",
    headlineParts: ["Beyond the ", "Stadium", ""],
    body: "Every shared game, every familiar cheer, every moment that brings us closer.",
    badge: "Caffeinated Beverage",
  },
  {
    src: "/images/xtreem/img-2.webp",
    alt: "Skydiver holding Xtreem Pro",
    eyebrow: "No Limits",
    headlineParts: ["Above ", "Everything", ""],
    body: "Big adventures feel better when you make room for the people and moments around you.",
    badge: "Your Moment",
  },
  {
    src: "/images/xtreem/img-3.webp",
    alt: "Mountain biker with Xtreem Pro",
    eyebrow: "Extreme Sports",
    headlineParts: ["Defy ", "Gravity", ""],
    body: "Find your pace, take the trail, and let the day unfold in its own way.",
    badge: "Your Rhythm",
  },
  {
    src: "/images/xtreem/img-4.webp",
    alt: "Skateboarder with Xtreem Pro in the city",
    eyebrow: "Street Culture",
    headlineParts: ["Own the ", "Concrete", ""],
    body: "The city is full of small connections. Notice them. Share them. Make them yours.",
    badge: "Made To Share",
  },
  {
    src: "/images/xtreem/img-5.webp",
    alt: "Footballer with Xtreem Pro",
    eyebrow: "The Game",
    headlineParts: ["Unleash Your ", "Moment", ""],
    body: "Whether you are playing, watching or simply being there, the moment belongs to you.",
    badge: "Your Moment",
  },
  {
    src: "/images/xtreem/img-6.webp",
    alt: "Xtreem Pro beside a Formula 1 track",
    eyebrow: "Formula Speed",
    headlineParts: ["Built for the ", "Fastest", ""],
    body: "Some days move fast. Keep a little space for the feeling that makes them yours.",
    badge: "Read The Label",
  },
  {
    src: "/images/xtreem/img-7.webp",
    alt: "Xtreem Pro held in a pit lane",
    eyebrow: "Pit Lane Ready",
    headlineParts: ["Your Day ", "Your Way", ""],
    body: "Read the label, choose responsibly, and take the next moment your way.",
    badge: "Caffeinated Beverage",
  },
];
