...
export default function Footer() {
  return (
    <footer className="bg-black text-white">
      <div className="mx-auto flex max-w-[1800px] flex-col items-center justify-between gap-10 px-4 py-10 sm:px-8 sm:py-14 md:px-16 lg:flex-row lg:items-start lg:py-16">
        {/* Logo */}
        <Image
      ...
      <div className="border border-black bg-primary-green px-4 py-2 text-center">
        <p className="mx-auto max-w-6xl text-[10px] font-bold uppercase leading-snug text-black sm:text-[11px]">
